clear all;
close all;
%Chambre1SimuStatiqueSC permet de calculer la temperature ambiante dans la chambre 1 sans chauffage
%ot : temperature exterieure
%dt : temperature de la porte
%n : nombre de points de la grille
function P1 = Chambre1SimuStatiqueSC(ot,dt,n)
x = linspace(-1,1,n);                            
[X,Y] = meshgrid(x,x);                           % grille bi-dimensionnelle 
G = (((X>-0.9) & (X<0.9) & (Y>-0.9) & (Y<0))|... %géométrie chambre 1
