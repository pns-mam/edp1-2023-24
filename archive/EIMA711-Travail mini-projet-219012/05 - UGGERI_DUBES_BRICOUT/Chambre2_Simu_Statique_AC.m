clear all;
close all;
%Chambre2SimuStatiqueAC permet de calculer la temperature ambiante dans la chambre 2 avec un chauffage
%ot : temperature exterieure
%dt : temperature de la porte
%ht : temperature du chauffage
%n : nombre de points de la grille
function P1 = Chambre2SimuStatiqueAC(ot,dt,ht,n)
x = linspace(-1,1,n);                            
...
%H = ((X>0.1) & (X<0.4) & (Y>-0.9) & (Y<-0.6));       % chauffage pres de la porte
