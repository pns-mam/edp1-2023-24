...
tic
ot=38;     % temperature exterieure donc celle de le fenetre
dp=22;     % la temperature de la porte dp
ht=-200;   %la temperature du chauffage ht
...
u0 = 29*ones(length(k),1);          % initialisation de la solution
...
while (temp>24 && it<nt)
    ...
    title('Climatiseur au niveau de la fenetre');
