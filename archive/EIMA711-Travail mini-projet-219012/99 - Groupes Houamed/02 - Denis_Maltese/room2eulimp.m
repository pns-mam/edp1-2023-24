function U = room2eulimp(ot,dt,ht,hdt,n,nu,alpha,eps,tinit)
  %{
Calcul de la solution itérative du problème de la partie 2 
...
nu: vitesse de diffusion(en dx/dt car dx=dy)
alpha: nombre de cfl
