...
U = RoomTemperature(-10,15,137,40);  % Permet de définir les valeurs initiales de notre fonction

x = linspace(-1,1,40);                            
[X,Y] = meshgrid(x,x);
MoyU = mean(mean(U((((X>-0.5) & (X<0.5) & (Y>-0.5) & (Y<0.5)) |...    % Pour avoir la temperature Moyenne uniquement sur notre chambre on lui redonne les dimensions de celle ci
