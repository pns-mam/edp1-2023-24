function U = Fonction_RoomTemperature2P2(ot,dt,ht,ht1,n,C0,t)

% La fonction calcule la température ambiante dans la chambre 2 pour la partie 2 du projet
...
% Et on affiche la température ambiante au cours du temps dans la chambre 2
